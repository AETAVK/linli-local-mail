...
当前源码是 `0.11.2` 候选，已从私有提交 `a010efca60df30cb1b3dd2da04904b3ce333f3f5` 生成尚未安装或发布的
本地候选安装包；尚无对应标签或正式发布物。上面的 `0.11.2` 映射是正式发布时应满足的一致性测试约束，
不是已完成的发布事实。`0.11.1` 曾生成一个未安装、未推送、未打标签、未发布的本地
