...
当前稳定版为 `0.11.11`。普通玩家可使用下方正式版安装器。

- [GitHub 0.11.11 正式发布页](https://github.com/AETAVK/linli-local-mail/releases/tag/v0.11.11)
- [Gitee 0.11.11 正式发布页（国内镜像）](https://gitee.com/sforlife/linli-local-mail/releases/tag/v0.11.11)
- [v0.11.11 发布说明](.github/release-notes/v0.11.11.md)
...
- [GitHub：下载 LinliLocalMail-0.11.11-Setup.exe](https://github.com/AETAVK/linli-local-mail/releases/download/v0.11.11/LinliLocalMail-0.11.11-Setup.exe)
- [Gitee：下载 LinliLocalMail-0.11.11-Setup.exe](https://gitee.com/sforlife/linli-local-mail/releases/download/v0.11.11/LinliLocalMail-0.11.11-Setup.exe)

普通玩家只需下载 `LinliLocalMail-0.11.11-Setup.exe`。Release 页面中的 `.sha256`、`.json` 和
...
完全退出游戏和官方启动器后，双击 `LinliLocalMail-0.11.11-Setup.exe`。安装器会自动识别当前目录，
...
- 独立歌曲映射表及 JSON 导入导出，支持曲名、路径和时段维护；导入前提示备份，同名文件采用导入值。
- 本地定制演奏的时段校正、画面辅助核对与扫描诊断。
- 曲库 / 信箱页签切换、UID 水印隐藏。
