...
当前稳定版为 `0.11.10`。普通玩家可使用下方正式版安装器。

- [GitHub 0.11.10 正式发布页](https://github.com/AETAVK/linli-local-mail/releases/tag/v0.11.10)
- [Gitee 0.11.10 正式发布页（国内镜像）](https://gitee.com/sforlife/linli-local-mail/releases/tag/v0.11.10)
- [v0.11.10 发布说明](.github/release-notes/v0.11.10.md)
...
- [GitHub：下载 LinliLocalMail-0.11.10-Setup.exe](https://github.com/AETAVK/linli-local-mail/releases/download/v0.11.10/LinliLocalMail-0.11.10-Setup.exe)
- [Gitee：下载 LinliLocalMail-0.11.10-Setup.exe](https://gitee.com/sforlife/linli-local-mail/releases/download/v0.11.10/LinliLocalMail-0.11.10-Setup.exe)

普通玩家只需下载 `LinliLocalMail-0.11.10-Setup.exe`。Release 页面中的 `.sha256`、`.json` 和
...
完全退出游戏和官方启动器后，双击 `LinliLocalMail-0.11.10-Setup.exe`。安装器会自动识别当前目录，
