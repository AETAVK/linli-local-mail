...
当前源码版本为 `0.10.9`，发布日期为 2026-09-02。

- [GitHub 发布页](https://github.com/AETAVK/linli-local-mail/releases/tag/v0.10.9)
- [Gitee 发布页（国内镜像）](https://gitee.com/sforlife/linli-local-mail/releases/tag/v0.10.9)
